                    ...
                    <div className="p-6 bg-white/60 dark:bg-[#18181b] rounded-3xl border border-white/40 dark:border-white/5 space-y-4 text-sm leading-relaxed shadow-sm">
                        ...
                        <div className="space-y-2 pt-2">
                            ...
                            <ol className="list-decimal list-inside space-y-1 text-slate-600 dark:text-stone-400 ml-1">
                                ...
                                <li>回到【Mirror页-核心共振参数（API）】，在上方 API 卡片中选择 <strong>Gemini</strong> 模式并填入 Key（该模式下<strong>Base URL须保持为空</strong>）</li>
                        ...
                        <div className="space-y-2 pt-2 border-t border-slate-200 dark:border-white/5 mt-4">
                            ...
                            <ol className="list-decimal list-inside space-y-1 text-slate-600 dark:text-stone-400 ml-1">
                                ...
                                <li>在【Mirror页-核心共振参数（API）】选择 <strong>OpenAI</strong> 模式，填入 <strong>Base URL</strong> 和 <strong>Key</strong></li>
                                <li>点击右下角刷新，加载模型，选择可使用模型 （如果无法选择，请将模型已填项全部清空）</li>
                            </ol>
                        </div>
                        

                        <p>*注：该应用仅 API Key 部分涉及联网，<strong>所有聊天数据只保存在你的浏览器中，没有云存储</strong>，如果你想保留对话记录，请点击页面下载按钮全量导出。</p>
                    </div>
                </div>
